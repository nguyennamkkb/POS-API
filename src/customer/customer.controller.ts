...
export class CustomerController {
  constructor(private readonly services: CustomerService, private readonly mainStoreService: MainStoreService) { }
  ...
  async create(
    ...
    try {
      const mainstore = await this.mainStoreService.findById(item.store_id);
